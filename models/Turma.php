...
public function vincularProfessorTurma($id_professor, $id_turma){
    try {
...
public function listarTurmasProfessor($id_professor)
{
    $sql = "SELECT t.id_turma, t.nome
            FROM turmas t
